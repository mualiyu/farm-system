      ...
      <div class="card">
        <div class="card-body">
          ...
          <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-3">
              <label for="o_name" class="form-label">Organization Name</label>
              <input type="text" class="form-control @error('o_name') is-invalid @enderror" id="o_name" name="o_name" placeholder="Enter the name of your organization">
            </div>
            <div class="mb-3">
