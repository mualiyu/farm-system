      ...
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            ...
            <p class="mb-4">{{Artisan::output()}}</p>

            <a href="{{url('/account-settings')}}" class="btn btn-sm btn-outline-primary">View Profile</a>
          </div>
        </div>
    ...
    <div class="card">
      <div class="row row-bordered g-0">
        ...
        <div class="col-md-4">
          ...
          <div class="text-center fw-semibold pt-3 mb-2">78% Crop Growth</div>
